namespace Axemasta.DateTimePicker.Extensions;

// For whatever reason the ReplaceMapping API is not available to net7.0, so I have copied this class from Maui:
// https://github.com/dotnet/maui/blob/main/src/Core/src/PropertyMapperExtensions.cs
